...
=======
	await character_speak(player, [ "But don’t you see that this doesn't apply anymore? Everyone else agrees with me." ])
>>>>>>> 6531de2 (Added options to flip and scale characters. Added new characters in scene 5. Changed the color of not talking to be darker.)
